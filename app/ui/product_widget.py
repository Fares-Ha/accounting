from PyQt6.QtWidgets import QWidget, QVBoxLayout, QPushButton, QTableWidget, QTableWidgetItem, QMessageBox, QDialog, QFormLayout, QLineEdit, QSpinBox, QDialogButtonBox
...
class ProductWidget(QWidget):
    def __init__(self):
        ...
        self.table.setHorizontalHeaderLabels([self.tr("ID"), self.tr("Name"), self.tr("Description"), self.tr("Price"), self.tr("Stock")])
